...
stator.addRegion('innerSlot', innerSlot, Air, 'Static', 'None'); 
...
rotor.addRegion('pm', permanentMagnet,  PermanentMagnetExampleMaterial, 'Dynamic', 'Isolated');
...
rotor.addRegion('fb1', fb1, Air, 'Static', 'None');
...
rotor.addRegion('fb2', fb2, Air, 'Static', 'None');
...
%% Configure algorithm
nSlotHarmonics = 1;
nTimePoints    = (2 * nTeethPerPhase * 3 + 1) * nSlotHarmonics + 1;
