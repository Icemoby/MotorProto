...
% 
% [slotOutline, slotNotch] = slotTemplate(nStatorTeeth, statorInnerRadius, statorOuterRadius, notchWidth, notchLength, slotWidth, slotLength, slotAngle, 'auto','InnerSlotShape','straight','InnerSlotLength',toothFaceWidth,'OuterSlotShape','rounded');
% 
...
% % simulation.configureAlgorithm('ShootingNewton', 'TimePoints', nTimePoints, 'RungeKuttaStages', 2, 'StoreDecompositions', true, 'Verbose', true, 'NewtonTolerance', 1e-4, 'TransientSolver', false, 'MaxShootingIterations', 20);
% 
