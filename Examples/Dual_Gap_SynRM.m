...
iStator.addRegion('islot1', slotNotch, Air, 'Static'); 
...
cut1 = cut1 * trim;
rotor.addRegion('cut1', cut1, Air, 'Static');
...
cut2 = cut2 * trim;
rotor.addRegion('cut2', cut2, Air, 'Static');

r = [0, Radii(3) * pi / Poles * 1 / 2];
c = [Radii(3)*cos(pi/Poles), Radii(3)*sin(pi/Poles)];
cut3 = Geometry2D.draw('Sector', 'Radius', r, 'Angle', 2*pi, 'Rotation', 0, 'Position', c);
cut3 = cut3 * trim;
rotor.addRegion('cut3', cut3, Air, 'Static');
...
oStator.addRegion('oslot1', slotNotch, Air, 'Static');
...
%% Set Excitation
iStator.SourceType                  = 'CurrentSource';
...
oStator.SourceType                  = 'CurrentSource';
